...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-base-200 text-gray-800">
	...
	<div className="py-6 text-sm text-center text-gray-600">© 2022 Filp-Mobile Co. All rights reserved.</div>
</footer>
    );
};
