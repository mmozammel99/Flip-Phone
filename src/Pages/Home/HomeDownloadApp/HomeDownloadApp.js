        ...
        <section className="py-6  text-gray-900">
            <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
                <div className="flex flex-col justify-center lg:text-left">
                    <p className="mb-1 text-3xl  font-medium tracking-widest uppercase title-font text-primary">Download the app</p>
                    <h1 className="py-2 font-medium leading-tight ">Buying & Selling is easier from our app too! To buy or sell on the go, download our app.</h1>
                </div>
                <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
                    <button className="inline-flex items-center px-6 py-3 rounded-lg bg-primary text-gray-50">
