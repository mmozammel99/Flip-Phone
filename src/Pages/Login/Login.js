...
const Login = () => {
    ...
    return (
        <div className="w-full max-w-md mx-auto my-20 p-8 space-y-3 rounded-xl bg-gray-50 text-gray-800">
            ...
            <form onSubmit={handleSubmit(onSubmit)} action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
                ...
                <div className="space-y-1 text-sm">
                    ...
                    <input type="password" className="w-full px-4 py-3 rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-green-600"
                        {...register("password", {
                            required: "Password is required",
                            minLength: { value: 6, message: "Password must be up to 6 characters " }
                        }
                ...
                <button className="block w-full p-3 text-center rounded-sm text-gray-50 bg-green-600">Sign in</button>
            </form>
